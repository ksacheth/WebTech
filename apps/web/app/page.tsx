              ...
              <div className="flex flex-col gap-10 lg:flex-row items-center">
                <div className="flex flex-col gap-6">
                  <div className="flex flex-col gap-4">
                    <span className="text-secondary font-bold tracking-widest uppercase text-xs">Integrity Redefined</span>
                    <h1 className="text-primary text-4xl md:text-6xl font-black leading-tight tracking-tight">Secure Online Proctoring for NITK Excellence</h1>
                    <p className="text-slate-600 dark:text-slate-400 text-lg md:text-xl font-normal leading-relaxed max-w-[540px]">
                      Experience the next generation of academic integrity with AI-enhanced lab proctoring. Trusted by top-tier universities to ensure fair outcomes.
                    </p>
                  </div>
                  <div className="flex flex-wrap gap-4">
                    <button className="flex min-w-[160px] cursor-pointer items-center justify-center rounded-xl h-14 px-8 bg-primary text-white text-lg font-bold shadow-lg hover:translate-y-[-2px] transition-all">
                      Get Started
                    </button>
            ...
            <div className="max-w-[1200px] mx-auto">
              <div className="relative overflow-hidden rounded-[2rem] bg-primary px-8 py-16 md:px-16 text-center text-white">
                ...
                <div className="relative z-10 flex flex-col items-center gap-8">
                  <div className="flex flex-col gap-4">
                    <h2 className="text-3xl md:text-5xl font-black tracking-tight">Ready to secure your next lab?</h2>
                    <p className="text-accent text-lg md:text-xl max-w-[600px] mx-auto opacity-90">Join the Department of Information Technology in setting the benchmark for secure online assessments in engineering education.</p>
                  </div>
        ...
        <footer className="bg-white dark:bg-background-dark border-t border-primary/5 px-6 md:px-20 py-12">
          <div className="max-w-[1200px] mx-auto grid grid-cols-1 md:grid-cols-4 gap-12">
            <div className="flex flex-col gap-4">
              ...
              <p className="text-slate-500 text-sm leading-relaxed">National Institute of Technology Karnataka, Surathkal. Department of Information Technology Proctoring Initiative.</p>
            </div>
            <div>
              <h4 className="text-primary font-bold mb-6">Product</h4>
              <ul className="flex flex-col gap-4 text-slate-500 text-sm">
                <li><Link href="#" className="hover:text-primary transition-colors">AI Monitoring</Link></li>
                <li><Link href="#" className="hover:text-primary transition-colors">Live Proctoring</Link></li>
            ...
            <div>
              ...
              <ul className="flex flex-col gap-4 text-slate-500 text-sm">
                ...
                <li><Link href="#" className="hover:text-primary transition-colors">Implementation</Link></li>
          ...
          <div className="max-w-[1200px] mx-auto mt-12 pt-8 border-t border-primary/5 flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-slate-400 text-xs">© 2024 National Institute of Technology Karnataka. All rights reserved.</p>
            <div className="flex gap-6">
              <Link href="#" className="text-slate-400 hover:text-primary transition-colors"><span className="material-symbols-outlined text-xl">language</span></Link>
              <Link href="#" className="text-slate-400 hover:text-primary transition-colors"><span className="material-symbols-outlined text-xl">share</span></Link>
            </div>
          </div>
        </footer>
      </div>
